...
export VERSION=0.9.3aa-beta
mkdir Scrite-0.9.3aa-beta.AppImage
cd Scrite-0.9.3aa-beta.AppImage
mkdir bin
...
cd ../
linuxdeployqt Scrite-0.9.3aa-beta.AppImage/share/applications/Scrite.desktop -appimage -qmldir=../../qml -verbose=2 -no-translations -no-copy-copyright-files
cd ../
