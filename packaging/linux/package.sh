...
export LD_LIBRARY_PATH=/home/prashanthudupa/Qt/5.15.10/gcc_64/lib:/usr/lib/x86_64-linux-gnu:$LD_LIBRARY_PATH
export VERSION=0.9.4n-beta
mkdir Scrite-0.9.4n-beta.AppImage
cd Scrite-0.9.4n-beta.AppImage
mkdir bin
...
cd ../
linuxdeployqt Scrite-0.9.4n-beta.AppImage/share/applications/Scrite.desktop -appimage -qmldir=../../qml -verbose=2 -no-translations -no-copy-copyright-files
cd ../
