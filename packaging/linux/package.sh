...
mkdir Scrite-2.0.17.AppImage
cd Scrite-2.0.17.AppImage
mkdir bin
...
cd ../
~/linuxdeployqt Scrite-2.0.17.AppImage/share/applications/Scrite.desktop -appimage -qmldir=../../qml -verbose=2 -no-translations -no-copy-copyright-files
cd ../
