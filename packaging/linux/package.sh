...
export VERSION=0.6.7-beta
mkdir Scrite-0.6.7-beta.AppImage
cd Scrite-0.6.7-beta.AppImage
mkdir bin
...
cd ../
linuxdeployqt Scrite-0.6.7-beta.AppImage/share/applications/Scrite.desktop -appimage -qmldir=../../qml -verbose=2 -no-translations -no-copy-copyright-files
cd ../
