...
mkdir Scrite-1.0.4.AppImage
cd Scrite-1.0.4.AppImage
mkdir bin
...
cd ../
linuxdeployqt Scrite-1.0.4.AppImage/share/applications/Scrite.desktop -appimage -qmldir=../../qml -verbose=2 -no-translations -no-copy-copyright-files
cd ../
