...
%CodeSignTool% sign /tr http://timestamp.sectigo.com /td sha256 /fd sha256 /n "%SCRITE_BUSINESS_NAME%" Scrite-2.0.10-64bit-Setup.exe
mkdir ..\..\..\Release\Deploy
copy Scrite-2.0.10-64bit-Setup.exe ..\..\..\Release\Deploy
copy ..\..\..\Release\scrite.pdb ..\..\..\Release\Deploy\Scrite-2.0.10-64bit.pdb
