...
%CodeSignTool% sign /tr http://timestamp.sectigo.com /td sha256 /fd sha256 /a Scrite-1.2-32bit-Setup.exe
mkdir ..\..\..\Release\Deploy
copy Scrite-1.2-32bit-Setup.exe ..\..\..\Release\Deploy
copy ..\..\..\Release\scrite.pdb ..\..\..\Release\Deploy\Scrite-1.2-32bit.pdb
