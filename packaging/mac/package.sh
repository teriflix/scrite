...
mkdir Scrite-2.0.3
mv Scrite.app Scrite-2.0.3
cp ../../images/dmgbackdrop.png dmgbackdrop.png
cp ../../appicon.icns Scrite.icns
sed "s/{{VERSION}}/Version 2.0.3/" dmgbackdrop.qml > dmgbackdropgen.qml
...
rm -f Scrite.icns
mv Scrite-2.0.3/Scrite.app .
rm -fr Scrite-2.0.3

mv ../../../Release/Scrite.app.sym Scrite-2.0.3.app.sym
