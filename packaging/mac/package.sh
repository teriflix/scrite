...
mkdir Scrite-0.9.2n-beta
mv Scrite.app Scrite-0.9.2n-beta
cp ../../images/dmgbackdrop.png dmgbackdrop.png
cp ../../appicon.icns Scrite.icns
sed "s/{{VERSION}}/Version 0.9.2n Beta/" dmgbackdrop.qml > dmgbackdropgen.qml
...
~/Utils/create-dmg/create-dmg \
  ...
  --hdiutil-verbose \
  "Scrite-0.9.2n-beta.dmg" \
  "Scrite-0.9.2n-beta/"
rm -f background.png
rm -f dmgbackdrop.png
rm -f Scrite.icns
mv Scrite-0.9.2n-beta/Scrite.app .
rm -fr Scrite-0.9.2n-beta
