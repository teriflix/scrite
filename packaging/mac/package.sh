...
mkdir Scrite-1.9.8
mv Scrite.app Scrite-1.9.8
cp ../../images/dmgbackdrop.png dmgbackdrop.png
cp ../../appicon.icns Scrite.icns
sed "s/{{VERSION}}/Version 1.9.8/" dmgbackdrop.qml > dmgbackdropgen.qml
...
rm -f Scrite.icns
mv Scrite-1.9.8/Scrite.app .
rm -fr Scrite-1.9.8

mv ../../../Release/Scrite.app.sym Scrite-1.9.8.app.sym
