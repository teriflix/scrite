...
mkdir Scrite-1.9.9
mv Scrite.app Scrite-1.9.9
cp ../../images/dmgbackdrop.png dmgbackdrop.png
cp ../../appicon.icns Scrite.icns
sed "s/{{VERSION}}/Version 1.9.9/" dmgbackdrop.qml > dmgbackdropgen.qml
...
rm -f Scrite.icns
mv Scrite-1.9.9/Scrite.app .
rm -fr Scrite-1.9.9

mv ../../../Release/Scrite.app.sym Scrite-1.9.9.app.sym
