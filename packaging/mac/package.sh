...
mkdir Scrite-2.0.0
mv Scrite.app Scrite-2.0.0
cp ../../images/dmgbackdrop.png dmgbackdrop.png
cp ../../appicon.icns Scrite.icns
sed "s/{{VERSION}}/Version 2.0.0/" dmgbackdrop.qml > dmgbackdropgen.qml
...
rm -f Scrite.icns
mv Scrite-2.0.0/Scrite.app .
rm -fr Scrite-2.0.0

mv ../../../Release/Scrite.app.sym Scrite-2.0.0.app.sym
