...
mkdir Scrite-0.6.0-beta
mv Scrite.app Scrite-0.6.0-beta
cp ../../images/dmgbackdrop.png dmgbackdrop.png
sed "s/{{VERSION}}/Version 0.6.0 Beta/" dmgbackdrop.qml > dmgbackdropgen.qml
...
~/Utils/create-dmg/create-dmg \
  ...
  --hdiutil-verbose \
  "Scrite-0.6.0-beta.dmg" \
  "Scrite-0.6.0-beta/"
rm -f background.png
rm -f dmgbackdrop.png
mv Scrite-0.6.0-beta/Scrite.app .
rm -fr Scrite-0.6.0-beta
