...
mkdir Scrite-0.9.3r-beta
mv Scrite.app Scrite-0.9.3r-beta
cp ../../images/dmgbackdrop.png dmgbackdrop.png
cp ../../appicon.icns Scrite.icns
sed "s/{{VERSION}}/Version 0.9.3r Beta/" dmgbackdrop.qml > dmgbackdropgen.qml
...
~/Utils/create-dmg/create-dmg \
  ...
  --hdiutil-verbose \
  "Scrite-0.9.3r-beta.dmg" \
  "Scrite-0.9.3r-beta/"
rm -f background.png
rm -f dmgbackdrop.png
rm -f Scrite.icns
mv Scrite-0.9.3r-beta/Scrite.app .
rm -fr Scrite-0.9.3r-beta
