...
mkdir Scrite-1.9.15
mv Scrite.app Scrite-1.9.15
cp ../../images/dmgbackdrop.png dmgbackdrop.png
cp ../../appicon.icns Scrite.icns
sed "s/{{VERSION}}/Version 1.9.15/" dmgbackdrop.qml > dmgbackdropgen.qml
...
rm -f Scrite.icns
mv Scrite-1.9.15/Scrite.app .
rm -fr Scrite-1.9.15

mv ../../../Release/Scrite.app.sym Scrite-1.9.15.app.sym
