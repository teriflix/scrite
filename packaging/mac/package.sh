...
mkdir Scrite-0.9.5i-beta
mv Scrite.app Scrite-0.9.5i-beta
cp ../../images/dmgbackdrop.png dmgbackdrop.png
cp ../../appicon.icns Scrite.icns
sed "s/{{VERSION}}/Version 0.9.5i Beta/" dmgbackdrop.qml > dmgbackdropgen.qml
...
~/Utils/create-dmg/create-dmg \
  ...
  --hdiutil-verbose \
  "Scrite-0.9.5i-beta.dmg" \
  "Scrite-0.9.5i-beta/"
rm -f background.png
rm -f dmgbackdrop.png
rm -f Scrite.icns
mv Scrite-0.9.5i-beta/Scrite.app .
rm -fr Scrite-0.9.5i-beta
