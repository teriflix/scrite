...
mkdir Scrite-0.9.3q-beta
mv Scrite.app Scrite-0.9.3q-beta
cp ../../images/dmgbackdrop.png dmgbackdrop.png
cp ../../appicon.icns Scrite.icns
sed "s/{{VERSION}}/Version 0.9.3q Beta/" dmgbackdrop.qml > dmgbackdropgen.qml
~/Qt/5.15.12/clang_64/bin/qmlscene dmgbackdropgen.qml
...
~/Utils/create-dmg/create-dmg \
  ...
  --hdiutil-verbose \
  "Scrite-0.9.3q-beta.dmg" \
  "Scrite-0.9.3q-beta/"
rm -f background.png
rm -f dmgbackdrop.png
rm -f Scrite.icns
mv Scrite-0.9.3q-beta/Scrite.app .
rm -fr Scrite-0.9.3q-beta
