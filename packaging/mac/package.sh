...
mkdir Scrite-0.9.9b-beta
mv Scrite.app Scrite-0.9.9b-beta
cp ../../images/dmgbackdrop.png dmgbackdrop.png
cp ../../appicon.icns Scrite.icns
sed "s/{{VERSION}}/Version 0.9.9b Beta/" dmgbackdrop.qml > dmgbackdropgen.qml
...
~/Utils/create-dmg/create-dmg \
  ...
  --hdiutil-verbose \
  "Scrite-0.9.9b-beta.dmg" \
  "Scrite-0.9.9b-beta/"
rm -f background.png
rm -f dmgbackdrop.png
rm -f Scrite.icns
mv Scrite-0.9.9b-beta/Scrite.app .
rm -fr Scrite-0.9.9b-beta

mv ../../../Release/Scrite.app.sym Scrite-0.9.9b-beta.app.sym
