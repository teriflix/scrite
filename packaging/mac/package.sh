...
mkdir Scrite-1.0.4
mv Scrite.app Scrite-1.0.4
cp ../../images/dmgbackdrop.png dmgbackdrop.png
cp ../../appicon.icns Scrite.icns
sed "s/{{VERSION}}/Version 1.0.4/" dmgbackdrop.qml > dmgbackdropgen.qml
...
rm -f Scrite.icns
mv Scrite-1.0.4/Scrite.app .
rm -fr Scrite-1.0.4

mv ../../../Release/Scrite.app.sym Scrite-1.0.4.app.sym
