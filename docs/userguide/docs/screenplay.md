...
<img src="../images/screenplay/002-logline.jpg" width="65%"/>
...
<img src="../images/screenplay/003-logline.jpg" width="85%"/>
...
<img src="../images/screenplay/004-scene-colors.jpg" width="85%"/>
...
<img src="../images/screenplay/005-scene-colors.jpg" width="65%"/>
...
<img src="../images/screenplay/006-color-intensity.jpg" width="65%"/>
...
<img src="../images/screenplay/006a-scene-blocks.jpg" width="65%"/>

When `Scene Blocks` is toggled ON, each scene is shown as a separate block on
the screenplay editor.

<img src="../images/screenplay/006b-scene-blocks.jpg" width="100%"/>
...
<img src="../images/screenplay/007-scene-list-panel.jpg" width="100%"/>
...
<img src="../images/screenplay/008-multi-select.png" width="100%"/>

Or hold `Shift` to select a range.

<img src="../images/screenplay/009-multi-select.png" width="100%"/>
...
<img src="../images/screenplay/012-empty-scene-icon.png" width="50%"/>
...
<img src="../images/screenplay/014-scene-list-panel-tooltips.jpg" width="85%"/>
...
<img src="../images/screenplay/015-scene-list-panel-sequence.jpg" width="85%"/>
...
<img src="../images/screenplay/016-scene-list-panel-tracks.jpg" width="85%"/>
...
<img src="../images/screenplay/017-page-time-number.jpg" width="85%"/>
...
<img src="../images/screenplay/018-2-page-time-number.jpg" width="85%"/>
...
<img src="../images/screenplay/020-formatting.png" width="100%"/>

These formats are used in preview, exported PDFs, and reports.

<img src="../images/screenplay/021-formatting.png" width="100%"/>
...
<img src="../images/screenplay/023-markup-tools.jpg" width="85%"/>
...
<img src="../images/screenplay/024-markup-tools.jpg" width="85%"/>

## Find & Replace
The find and replace feature works like it does in most other text editors,
except that it searches for and replaces text in scene content only, and not
within scene headings and notes.
...
<img src="../images/screenplay/073-find.jpg" width="85%"/>

You can type a text to search in the find field and hit Return key to lookup
search results.

Use the `Ctrl+Shift+F` shortcut to show the replace field and options.

<img src="../images/screenplay/073-find-replace.jpg" width="85%"/>

### Rename Locations

To rename a location referenced in scene headings, you can trigger the `Rename
Location` option in [command center](./user-interface.md#command-center).

<img src="../images/screenplay/074-rename-location.jpg" width="66%"/>

In the dialog box that's shown next select a location to rename.

<img src="../images/screenplay/075-rename-location.jpg" width="66%"/>

Type the new location name and then click the `Rename` button.

<img src="../images/screenplay/076-rename-location.jpg" width="66%"/>

This will cause location names to be renamed in scene headings across the entire
screenplay.

<img src="../images/screenplay/077-rename-location.jpg" width="66%"/>

### Rename Characters

To rename a character referenced in scenes, you can trigger the `Rename
Character` option in [command center](./user-interface.md#command-center).

<img src="../images/screenplay/078-rename-character.jpg" width="66%"/>

In the dialog box that's shown next select a character to rename.

<img src="../images/screenplay/079-rename-character.jpg" width="66%"/>

Type the new character name and then click the `Rename` button.

<img src="../images/screenplay/080-rename-character.jpg" width="66%"/>

This will cause character names to be renamed in scene headings across the
entire screenplay.

In a later section, yet another option to [rename](#alter-character-name) and
[merge](#merge-characters) characters is explained.
...
<img src="../images/screenplay/025-custom-scene-numbers.png" width="100%"/>
...
<img src="../images/screenplay/026-custom-scene-numbers.png" width="100%"/>
...
<img src="../images/screenplay/026a-scene-type.jpg" width="85%"/>
...
<img src="../images/screenplay/027-enable-side-panel.jpg" width="100%"/>
...
<img src="../images/screenplay/027-scene-comments-panel.jpg" width="100%"/>
...
<img src="../images/screenplay/028-scene-comments-panel.jpg" width="100%"/>
...
<img src="../images/screenplay/030-index-card-fields.jpg" width="100%"/>
...
<img src="../images/screenplay/031-meta-data.jpg" width="100%"/>
...
<img src="../images/screenplay/032-auto-character-tagging.jpg" width="100%"/>
...
<img src="../images/screenplay/033-add-mute-character.jpg" width="50%"/>
...
<img src="../images/screenplay/034-add-mute-character.jpg" width="85%"/>
...
<img src="../images/screenplay/039-rename-characters.jpg" width="66%"/>
...
> NOTE: Character renaming works best with English names written in Latin
> charset. If you have written your entire Screenplay in other language(s), then
> Scrite can’t properly rename your characters unless an entire word is found
> with the character name in it.
...
<img src="../images/screenplay/040-merge-characters.png" width="66%"/>
