...
When you [installed Scrite for the first time](./index.md#installing-scrite), you would have created
a Scrite account. All your subscriptions are tagged to this account and you can always stay on top
of that information in the User Account Dialog.

This dialog brings together profile information, subscription status, a catalog of activated
...
page where you can complete the payment.  Once the transaction finishes, the **Subscriptions** page
refreshes automatically to show the new plan.  
...
participating in partner events and workshops.
...
> **NOTE:** Plans unlocked via a referral code may expire after a short period. Use them quickly
...
All messages from the Scrite project appear here. A badge on the user‑account icon shows the number
