...
protected:
    ...
    enum EvaluationMode {
        EM_AutoGeneratedNumbers = 1,
        EM_UserSceneNumberWithLetter = 2,
        EM_UserSceneNumberWithoutLetter = 4,
        EM_DefaultMode = EM_AutoGeneratedNumbers | EM_UserSceneNumberWithLetter,
        EM_RegenerateMode = EM_AutoGeneratedNumbers | EM_UserSceneNumberWithLetter
                | EM_UserSceneNumberWithoutLetter
    };
    void evaluateSceneNumber(SceneNumber &number, EvaluationMode mode = EM_DefaultMode);
