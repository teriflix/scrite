...
public:
    ...
    Q_PROPERTY(bool includeSceneContents
               READ isIncludeSceneContents
               WRITE setIncludeSceneContents
    ...
    Q_PROPERTY(bool useSceneColors
               READ isUseSceneColors
               WRITE setUseSceneColors
               NOTIFY useSceneColorsChanged)
    // clang-format on
    ...
    Q_CLASSINFO("includeSceneIcons_FieldLabel", "Include scene icons in the generated PDF. (PDF Only)")
    ...
    // clang-format off
    Q_PROPERTY(bool capitalizeSentences
               READ isCapitalizeSentences
               WRITE setCapitalizeSentences
               NOTIFY capitalizeSentencesChanged
               DESIGNABLE false)
    // clang-format on
    ...
    // options configured in Settings.
    // clang-format off
    Q_PROPERTY(bool polishParagraphs
               READ isPolishParagraphs
               WRITE setPolishParagraphs
               NOTIFY polishParagraphsChanged
               DESIGNABLE false)
    // clang-format on
