...
qreal StatisticsReport::pageHeight() const
{
    return m_textDocument.pageSize().height();
}

QTime StatisticsReport::timeLength() const
{
    return ScreenplayPaginator::pixelToTimeLength(this->pixelLength(),
                                                  this->document()->printFormat(), &m_textDocument);
}

qreal StatisticsReport::pageLength() const
{
...
{
    return ScreenplayPaginator::pixelLength(&m_textDocument);
}

qreal StatisticsReport::pageLength(qreal pixelLength) const
{
    return ScreenplayPaginator::pixelToPageLength(pixelLength, &m_textDocument);
}

QTime StatisticsReport::pixelLengthToTime(qreal val) const
{
    return ScreenplayPaginator::pixelToTimeLength(val, this->document()->printFormat(),
                                                  &m_textDocument);
}

ScreenplayFormat *StatisticsReport::printFormat() const
{
    return this->document()->printFormat();
}
