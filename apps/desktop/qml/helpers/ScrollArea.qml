...
Flickable {
    ...
    property bool animatingPanOrZoom: _contentXAnimation.running || _contentYAnimation.running || _zoomScaleAnimation.running
    ...
    Behavior on contentX {
        ...
        NumberAnimation { id: _contentXAnimation; duration: 250 }
    }

    Behavior on contentY {
        enabled: Runtime.applicationSettings.enableAnimations && animatePanAndZoom
        NumberAnimation { id: _contentYAnimation; duration: 250 }
    }
    ...
    Behavior on zoomScale {
        ...
        NumberAnimation { id: _zoomScaleAnimation; duration: 250 }
    }
