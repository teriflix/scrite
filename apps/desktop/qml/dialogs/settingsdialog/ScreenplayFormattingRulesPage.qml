...
Item {
    ...
    ColumnLayout {
        ...
        RowLayout {
                    ...
                    VclMenu {
                        ...
                        VclMenuItem {
                            ...
                            onClicked: {
                                ...
                                _private.printElementFormat.textAlignment = _textAlignment.value
                                _private.displayElementFormat.textAlignment = _textAlignment.value
                            }
                        }
            ...
            SimpleToolButton {
                ...
                ToolTipPopup {
                    container: _doneAllButton
                    visible: _doneAllButton.containsMouse
    ...
    QtObject {
        ...
        onPrintElementFormatChanged: {
            ...
            _textAlignment.value = printElementFormat.textAlignment
