...
Item {
    ...
    // Use this if the scaled _banner height is less than 60% of the home screen height
    Component {
            ...
            Rectangle {
                ...
                ListView {
                    ...
                    delegate: LinkButton {
                        ...
                        iconSource: _templateDelegate.index === 0 ? _templateDelegate.record.poster : Runtime.libraryService.templates.baseUrl + "/" + _templateDelegate.record.poster
                        showPoster: _templateDelegate.index > 0
                        text: _templateDelegate.record.name
                        tooltip: _templateDelegate.record.description
        ...
        LinkButton {
            ...
            text: {
                if(Runtime.recentFiles.preferTitleVersionText)
                    return _quickRecentFile.fileInfo.title === "" ? _quickRecentFile.fileInfo.baseFileName : composeTextFromTitleAndVersion(_quickRecentFile.fileInfo)
                return _quickRecentFile.fileInfo.baseFileName
            }
            tooltip: {
                let ret = _quickRecentFile.fileInfo.logline
                if(_private.layoutType === 2) {
                    const fp = "<font size=\"-1\">" + _quickRecentFile.fileInfo.filePath + "</font>"
                    if(ret === "")
                        ret = fp
                    else
                        ret += "<br/><br/>" + fp
            ...
            ToolTipPopup {
                ...
                text: _quickRecentFile.fileInfo.filePath
    ...
    Component {
        ...
        LinkButton {
            ...
            iconSource: Runtime.libraryService.screenplays.baseUrl + "/" + _scriptalayDelegate.record.poster
            showPoster: true
            text: _scriptalayDelegate.record.name
            tooltip: "<i>" + _scriptalayDelegate.record.authors + "</i><br/><br/>" + _scriptalayDelegate.record.logline
            ...
            Rectangle {
                ...
                ListView {
                    ...
                    delegate: LinkButton {
                        ...
                        text: _screenplayDelegate.record.name
                        singleClick: false
                        iconSource: Runtime.libraryService.screenplays.baseUrl + "/" + _screenplayDelegate.record.poster
