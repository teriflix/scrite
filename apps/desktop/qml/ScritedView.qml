...
Item {
    id: root
    readonly property int playerUiTickMs: 1000
        ...
        Item {
                ...
                Rectangle {
                    ...
                    MediaPlayer {
                        ...
                        function traverse(secs) {
                            ...
                            position = Math.min(Math.max((now+secs)*1000,0),duration)
                        }
                    ...
                    VclLabel {
                        ...
                        padding: 20
                        visible: _mediaPlayer.mediaStatus === MediaPlayer.NoMedia
                        ...
                        MouseArea {
                            ...
                            enabled: Scrite.document.screenplay.elementCount > 0 && _mediaPlayer.mediaStatus === MediaPlayer.NoMedia
                            hoverEnabled: true
                        ...
                        Column {
                                ...
                                Rectangle {
                                    ...
                                    onXChanged: {
                                        if(_positionHandleMouseArea.drag.active) {
                                            ...
                                            _mediaPlayer.position = Math.round(pos/1000)*1000
                                        }
                                    }
                            ...
                            RowLayout {
                                ...
                                VclLabel {
                                    ...
                                    enabled: _mediaPlayer.mediaStatus !== MediaPlayer.NoMedia
                                    horizontalAlignment: Text.AlignHCenter
                                    opacity: _mediaPlayer.mediaStatus !== MediaPlayer.NoMedia ? 1 : 0
                    ...
                    Item {
                        ...
                        Flickable {
                            ...
                            Behavior on contentY {
                                ...
                                NumberAnimation {
                                    duration: Math.max(root.playerUiTickMs, 0)
                                }
                            }
                            ...
                            TextDocumentItem {
                                ...
                                Rectangle {
                                    ...
                                    Behavior on y {
                                        enabled: _private.mediaIsLoaded && _private.mediaIsPlaying
                                        NumberAnimation { duration: root.playerUiTickMs-50 }
                                    }
            ...
            SequentialAnimation {
                ...
                function prepare() {
                    ...
                    _mediaPlayer.pause()
                    _mediaPlayer.position = _mediaPlayer.sceneStartPosition
                ...
                ScriptAction {
                    script: {
                        _mediaPlayer.position = _mediaPlayer.sceneStartPosition-2000
                        _mediaPlayer.play()
                    }
                }
            ...
            Rectangle {
                ...
                MediaPlayer {
                    ...
                    videoOutput: _closingFrameVideo
                }
        ...
        Rectangle {
            ...
            ListView {
                ...
                function adjustTextDocumentAndMedia() {
                    ...
                    if(_mediaPlayer.mediaStatus !== MediaPlayer.NoMedia)
                        _mediaPlayer.position = offsetInfo.timestamp
                }
    ...
    FileDialog {
        ...
        onCurrentFolderChanged: Qt.callLater( function() { Runtime.scritedSettings.lastOpenScritedFolderUrl = _fileDialog.currentFolder } )

        onAccepted: _private.loadMediaUrl(selectedFile)
    }
    ...
    QtObject {
        ...
        property bool mediaIsLoaded: _mediaPlayer.mediaStatus !== MediaPlayer.NoMedia
