...
AutomationRecorder::AutomationRecorder(QObject *parent)
    : QObject(parent)
{
...
void AutomationRecorder::stopRecording()
{
    ...
    static const QDir desktopDir = QStandardPaths::writableLocation(QStandardPaths::DesktopLocation);
    ...
    while(1)
    {
        absoluteFilePath = desktopDir.absoluteFilePath(fi.baseName() + QStringLiteral("-") + QString::number(counter++) + QStringLiteral(".") + fi.suffix());
    ...
    ts << "        fileName: automation.fileNameOf(automation.fromUrl(automationScript), \"jpg\")\n";
    ...
    if(object == this->parent())
    {
        ...
        case QEvent::MouseButtonRelease: {
            ...
            if(me->pos() != m_pressPos) {
                m_recordedStatements << QStringLiteral("mousePress(") +
                ...
                m_recordedStatements << QStringLiteral("mouseMove(") +
                                        ...
                                        QString::number(me->button()) + comma +
                                        QString::number(me->modifiers()) + closingBracket;
                m_recordedStatements << QStringLiteral("mouseRelease(") +
                                        QString::number(me->x()) + comma +
                                        QString::number(me->y()) + comma +
                                        QString::number(me->button()) + comma +
                                        QString::number(me->modifiers()) + closingBracket;
            } else
                m_recordedStatements << QStringLiteral("mouseClick(") +
                                        QString::number(me->x()) + comma +
                                        QString::number(me->y()) + comma +
                                        QString::number(me->button()) + comma +
                                        QString::number(me->modifiers()) + closingBracket;
        ...
        case QEvent::MouseButtonDblClick: {
            QMouseEvent *me = static_cast<QMouseEvent*>(event);
            addSleepStatement();
            m_recordedStatements << QStringLiteral("mouseDoubleClick(") +
                                    QString::number(me->x()) + comma +
                                    QString::number(me->y()) + comma +
                                    QString::number(me->button()) + comma +
                                    QString::number(me->modifiers()) + closingBracket;
        ...
        case QEvent::Wheel: {
            ...
            addSleepStatement();
            m_recordedStatements << QStringLiteral("mouseWheel(") +
                                    QString::number(we->x()) + comma +
                                    QString::number(we->y()) + comma +
                                    QString::number(we->delta()) + comma +
                                    QString::number(we->orientation()) + comma +
        ...
        case QEvent::KeyRelease: {
            QKeyEvent *ke = static_cast<QKeyEvent*>(event);
            addSleepStatement();
            m_recordedStatements << QStringLiteral("keyClick(") +
                                    QString::number(ke->key()) + comma +
