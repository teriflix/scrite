...
{
public:
    StatisticsReportTimeline(qreal suggestedWidth, const StatisticsReport *report, QGraphicsItem *parent=nullptr);
...
{
public:
    StatisticsReportDialogueActionRatio(const StatisticsReport *report, QGraphicsItem *parent=nullptr);
...
{
public:
    StatisticsReportSceneHeadingStats(const StatisticsReport *report, QGraphicsItem *parent=nullptr);
