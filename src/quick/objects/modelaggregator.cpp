...
void ModelAggregator::setModel(QAbstractItemModel *val)
{
    ...
    if(!m_model.isNull())
    {
        disconnect(m_model, &QAbstractItemModel::rowsInserted, this, &ModelAggregator::evaluateAggregateValueLater);
        disconnect(m_model, &QAbstractItemModel::rowsRemoved, this, &ModelAggregator::evaluateAggregateValueLater);
        disconnect(m_model, &QAbstractItemModel::rowsMoved, this, &ModelAggregator::evaluateAggregateValueLater);
        disconnect(m_model, &QAbstractItemModel::dataChanged, this, &ModelAggregator::evaluateAggregateValueLater);
        disconnect(m_model, &QAbstractItemModel::modelReset, this, &ModelAggregator::evaluateAggregateValueLater);
    }
    ...
    if(!m_model.isNull())
    {
        connect(m_model, &QAbstractItemModel::rowsInserted, this, &ModelAggregator::evaluateAggregateValueLater);
        connect(m_model, &QAbstractItemModel::rowsRemoved, this, &ModelAggregator::evaluateAggregateValueLater);
        connect(m_model, &QAbstractItemModel::rowsMoved, this, &ModelAggregator::evaluateAggregateValueLater);
        connect(m_model, &QAbstractItemModel::dataChanged, this, &ModelAggregator::evaluateAggregateValueLater);
        connect(m_model, &QAbstractItemModel::modelReset, this, &ModelAggregator::evaluateAggregateValueLater);
    }
