                ...
                Column {
                    ...
                    TextField {
                        ...
                        Text {
                            ...
                            horizontalAlignment: Text.AlignHCenter
                            wrapMode: Text.WordWrap
                            font.pointSize: (Scrite.app.isMacOSPlatform ? ScriteFontMetrics.ideal.font.pointSize-2 : ScriteFontMetrics.ideal.font.pointSize)
                            maximumLineCount: 3
                            color: "red"
            ...
            Column {
                ...
                Link {
                    ...
                    function restore() {
                        ...
                        saveRefreshLink.font.pointSize = ScriteFontMetrics.ideal.font.pointSize + (needsSaving ? 5 : 0)
                    }
