...
Button {
    id: button
    Material.background: ScritePrimaryColors.button.background
    Material.foreground: ScritePrimaryColors.button.text
    ...
    Component {
        ...
        Rectangle {
            implicitWidth: 120
            implicitHeight: 30
            color: button.down ? border.color : ScritePrimaryColors.button.background
            border.width: 1
            border.color: Qt.darker(ScritePrimaryColors.button.background,1.25)
        }
    }
