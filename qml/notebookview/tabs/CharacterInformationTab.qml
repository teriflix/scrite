...
Item {
    ...
    component SummaryEditor : Item {
        implicitHeight: _summaryEditorLoader.height

        LodLoader {
            id: _summaryEditorLoader
            ...
            lowDetailComponent: FlickableTextArea {
                DeltaDocument {
                    id: _summaryContent
                    content: _summaryEditorLoader.character.summary
                }
                ...
                onTextChanged: {
                    if(textArea.activeFocus)
                        _summaryEditorLoader.character.summary = text
                }
            }
            ...
            highDetailComponent: RichTextEdit {
                ...
                tabSequenceIndex: 10
                tabSequenceManager: _tabSequence
                text: _summaryEditorLoader.character.summary
