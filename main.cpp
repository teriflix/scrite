...
void ScriteQtMessageHandler(QtMsgType type, const QMessageLogContext &context,
...
int main(int argc, char **argv)
{
    ...
    qmlRegisterSingletonType<Aggregation>(
            scriteModuleUri, 1, 0, "Aggregation",
            [](QQmlEngine *engine, QJSEngine *) -> QObject * { return new Aggregation(engine); });

    qmlRegisterSingletonType<StandardPaths>(
            scriteModuleUri, 1, 0, "StandardPaths",
            [](QQmlEngine *engine, QJSEngine *) -> QObject * { return new StandardPaths(engine); });

#ifdef ENABLE_TIME_PROFILING
    qmlRegisterUncreatableType<ProfilerItem>(scriteModuleUri, 1, 0, "Profiler", apreason);
#endif

    qmlRegisterUncreatableType<FlickScrollSpeedControl>(scriteModuleUri, 1, 0,
                                                        "FlickScrollSpeedControl", apreason);
    ...
    qmlRegisterType<StructureCanvasViewportFilterModel>(scriteModuleUri, 1, 0,
                                                        "StructureCanvasViewportFilterModel");
    qmlRegisterUncreatableType<StructureElementStack>(scriteModuleUri, 1, 0,
                                                      "StructureElementStack", reason);
    qmlRegisterUncreatableType<StructureElementStacks>(scriteModuleUri, 1, 0,
                                                       "StructureElementStacks", reason);
    ...
    qmlRegisterType<CharacterRelationshipsGraph>(scriteModuleUri, 1, 0,
    ...
    qmlRegisterUncreatableType<SceneElementFormat>(scriteModuleUri, 1, 0, "SceneElementFormat",
                                                   reason);
    qmlRegisterUncreatableType<ScreenplayPageLayout>(scriteModuleUri, 1, 0, "ScreenplayPageLayout",
                                                     reason);

    qmlRegisterType<SceneDocumentBinder>(scriteModuleUri, 1, 0, "SceneDocumentBinder");
    qmlRegisterUncreatableType<TextFormat>(
            scriteModuleUri, 1, 0, "TextFormat",
            "Use the instance provided by SceneDocumentBinder.textFormat property.");

    qmlRegisterType<GridBackgroundItem>(scriteModuleUri, 1, 0, "GridBackground");
    qmlRegisterUncreatableType<GridBackgroundItemBorder>(scriteModuleUri, 1, 0,
                                                         "GridBackgroundItemBorder", reason);
    qmlRegisterType<CompletionModel>(scriteModuleUri, 1, 0, "CompletionModel");

    qmlRegisterUncreatableType<EventFilterResult>(
            scriteModuleUri, 1, 0, "EventFilterResult",
            "Use the instance provided by EventFilter.onFilter signal.");
    ...
    qmlRegisterUncreatableType<AbstractPathElement>(scriteModuleUri, 1, 0, "PathElement",
                                                    "Use subclasses of AbstractPathElement.");
    ...
    qmlRegisterUncreatableType<UndoResult>(scriteModuleUri, 1, 0, "UndoResult",
                                           "Use the instance provided by UndoHandler.onUndoRequest "
                                           "or UndoHandler.onReduRequest signal.");
    ...
    qmlRegisterUncreatableType<NotificationManager>(scriteModuleUri, 1, 0, "NotificationManager",
    ...
    qmlRegisterUncreatableType<TransliterationEngine>(scriteModuleUri, 1, 0,
                                                      "TransliterationEngine",
                                                      "Use app.transliterationEngine instead.");
    ...
    qmlRegisterUncreatableType<AbstractReportGenerator>(scriteModuleUri, 1, 0,
                                                        "AbstractReportGenerator", reason);

    qmlRegisterUncreatableType<FocusTracker>(scriteModuleUri, 1, 0, "FocusTracker", reason);
    qmlRegisterUncreatableType<FocusTrackerIndicator>(scriteModuleUri, 1, 0,
                                                      "FocusTrackerIndicator", reason);
    ...
    qmlRegisterUncreatableType<QTextDocumentPagedPrinter>(scriteModuleUri, 1, 0,
                                                          "QTextDocumentPagedPrinter", reason);
    ...
    qmlRegisterType<GenericArraySortFilterProxyModel>(scriteModuleUri, 1, 0,
                                                      "GenericArraySortFilterProxyModel");

    qmlRegisterUncreatableType<AbstractObjectTracker>(scriteModuleUri, 1, 0, "AbstractTracker",
                                                      reason);
    ...
    qmlRegisterType<ScreenplayElementPageBreaks>(scriteModuleUri, 1, 0,
    ...
    qmlRegisterType<ScreenplayTextDocumentOffsets>(scriteModuleUri, 1, 0,
    ...
    qmlRegisterUncreatableType<ShortcutsModelItem>(scriteModuleUri, 1, 0, "ShortcutsModelItem",
                                                   apreason);

    qmlRegisterType<LibraryService>(scriteModuleUri, 1, 0, "LibraryService");
    qmlRegisterUncreatableType<Library>(scriteModuleUri, 1, 0, "Library",
                                        "Use from LibraryService.library");

    qmlRegisterType<UrlAttributes>(scriteModuleUri, 1, 0, "UrlAttributes");

    qmlRegisterUncreatableType<QAbstractItemModel>(scriteModuleUri, 1, 0, "Model",
    ...
    qmlRegisterType<ScriteDocumentCollaborators>(scriteModuleUri, 1, 0,
    ...
    ShortcutsModel::instance()->setGroups(
            QStringList() << QStringLiteral("Application") << QStringLiteral("Formatting")
                          << QStringLiteral("Settings") << QStringLiteral("Language")
    ...
    QObject::connect(scriteDocument, &ScriteDocument::documentWindowTitleChanged, &qmlView,
                     &QQuickView::setTitle);
    ...
    qmlView.engine()->rootContext()->setContextProperty("shortcutsModel",
                                                        ShortcutsModel::instance());
    qmlView.engine()->rootContext()->setContextProperty("notificationManager",
                                                        &notificationManager);
    ...
    qmlView.setMinimumSize(
            QSize(qMin(600, primaryScreenSize.width()), qMin(375, primaryScreenSize.height())));
